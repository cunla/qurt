...
public class ReportLine {
    ...
    public ReportLine(int year, int month, String country, int stateSource, int stateLocal, int stateRemote) {
    ...
    public String asCsv() {
        return String.format("%d,%d,%s,%d,%d,%d", month, year, country, stateSource, stateLocal, stateRemote);
    }
